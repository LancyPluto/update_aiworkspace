...
test("material picker modals paginate uploads and generated assets", async () => {
  ...
  assert.match(capabilityControls, /materialVideoPreviewUrl/)
  assert.match(capabilityControls, /asset\.kind === 'video' && asset\.previewUrl/)
  assert.match(capabilityControls, /layout\?: "default" \| "composer"/)
  assert.match(capabilityControls, /SlidersHorizontal/)

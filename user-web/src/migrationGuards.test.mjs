...
test("migration handoff docs do not contain known mojibake tokens", async () => {
  const plan = await readFile(new URL("../../docs/superpowers/plans/2026-05-31-qianduan-user-web-migration.md", srcRoot), "utf8")
  const bannedTokens = [
    "閱嬮吀閽燶",
    "浠诲姟宸插彇娑",
    "宸插彇娑",

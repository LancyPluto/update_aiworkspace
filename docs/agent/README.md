...
| [LangGraph运行闭环开发与验收文档.md](./LangGraph运行闭环开发与验收文档.md) | LangGraph checkpoint、确认恢复、执行锁、幂等、迁移和真实环境验收记录；包含明确的未完成项 |
| [链路梳理（小学生版）.md](./链路梳理（小学生版）.md) | 通俗易懂的一次请求链路讲解，用于快速理解与新人交接 |
| [Agent工具路由链路与Skill分层评估-2026-06-29.md](./Agent工具路由链路与Skill分层评估-2026-06-29.md) | 当前工具路由、渐进披露、Skill Hydration、图像/音乐能力分层评估，以及为什么不应按“一个模型一个 Skill”长期维护 |
| [工具注册Agent-Skill设计方案.md](./工具注册Agent-Skill设计方案.md) | 后台工具注册改成 Skill 式渐进披露的设计方案，含元 skill、字段策略编译和一键生成草稿契约 |
| [Agent上下文回溯稽查优化计划-2026-07-13.md](./Agent上下文回溯稽查优化计划-2026-07-13.md) | Run 不可变上下文、逐次模型请求、Skill/工具披露证据、规则归因和管理后台稽查闭环 |

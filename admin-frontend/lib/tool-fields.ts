...
export function createImageTemplateFields(): EditableField[] {
  return [
    {
      ...createEmptyField(1),
    ...
    },
    {
      ...
      fieldName: "效果风格",
      fieldType: "radio",
      placeholder: "选择生成效果风格",
      required: false,
      executionRequired: false,
      userRequired: false,
      defaultValue: "ecommerce",
      options: [
        { label: "商品图", value: "ecommerce", promptPrefix: "clean ecommerce product image, premium commercial look" },
        { label: "透明背景", value: "transparent", promptPrefix: "remove background, transparent PNG, clean edges" },
        { label: "白底图", value: "white_bg", promptPrefix: "white background, clean product photography" },
        { label: "社媒海报", value: "social_poster", promptPrefix: "social media poster style, eye-catching composition" },
      ],
    },
    {
      ...createEmptyField(3),
...
export function createVideoTemplateFields(): EditableField[] {
  return [
    {
      ...createEmptyField(1),
    ...
    },
    {
      ...
      fieldName: "视频能力",
      fieldType: "radio",
      placeholder: "选择视频工具要执行的能力方向",
      required: false,
      executionRequired: false,
      userRequired: false,
      defaultValue: "face_swap",
      options: [
        { label: "视频换脸", value: "face_swap", promptPrefix: "video face swap, preserve motion and lighting" },
        { label: "数字人", value: "digital_human", promptPrefix: "digital human presenter, natural lip sync" },
        { label: "动作替换", value: "motion_transfer", promptPrefix: "motion transfer, preserve subject identity" },
        { label: "图生视频", value: "image_to_video", promptPrefix: "animate reference image into a cinematic video" },
      ],
    },
  ]
}

export function createDigitalHumanTemplateFields(): EditableField[] {
  return [
    {
      ...createEmptyField(1),
      fieldKey: "referenceImageUrl",
    ...
    },
    {
      ...
      fieldName: "声音风格",
      fieldType: "radio",
      placeholder: "选择数字人声音风格",
      required: false,
      executionRequired: false,
      userRequired: false,
      defaultValue: "professional",
      options: [
        { label: "专业讲解", value: "professional", promptPrefix: "professional presenter voice, clear pronunciation" },
        { label: "亲和导购", value: "friendly", promptPrefix: "friendly sales host voice, warm and natural" },
        { label: "知识博主", value: "educational", promptPrefix: "educational creator voice, confident and calm" },
      ],
    },
    {
      ...createEmptyField(4),
      ...
      fieldName: "出镜场景",
      fieldType: "radio",
      placeholder: "选择数字人展示场景",
      required: false,
      executionRequired: false,
      userRequired: false,
      defaultValue: "studio",
      options: [
        { label: "直播间", value: "live_room", promptPrefix: "livestream studio background" },
        { label: "产品展台", value: "product_stage", promptPrefix: "product showcase stage background" },
        { label: "办公室", value: "office", promptPrefix: "modern office background" },
        { label: "纯色演播室", value: "studio", promptPrefix: "clean studio background" },
      ],
    },
    {
      ...createEmptyField(5),

...
// Validate ../../app/agent-runs/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/agent-runs">> = Specific
  const handler = {} as typeof import("../../app/agent-runs/page.js")

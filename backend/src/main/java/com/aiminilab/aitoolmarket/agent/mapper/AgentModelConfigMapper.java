...
public interface AgentModelConfigMapper extends BaseMapper<AgentModelConfig> {
    ...
    @Insert("""
            ...
            VALUES(#{config.vendorAccountId}, #{config.routingPoolId}, #{config.displayName}, #{config.configCode}, #{config.provider}, #{config.modelName},
                   ...
                   #{config.executionOptionsJson}, #{config.requestSchemaJson}, #{config.requestMappingJson},
                   #{config.responseMappingJson}, #{config.apiContractVersion}, #{config.contractStatus},
                   #{config.contractVerifiedAt}, #{config.minimaxGroupId},
    ...
    @Update("""
            ...
            SET vendor_account_id = #{config.vendorAccountId},
                ...
                request_schema_json = #{config.requestSchemaJson},
                request_mapping_json = #{config.requestMappingJson},
                response_mapping_json = #{config.responseMappingJson},
                api_contract_version = #{config.apiContractVersion},
                contract_status = #{config.contractStatus},
                contract_verified_at = #{config.contractVerifiedAt},
